package com.kundankishore.flight_tickets.view;
...
import com.kundankishore.flight_tickets.R;
import com.kundankishore.flight_tickets.network.ApiClient;
import com.kundankishore.flight_tickets.network.ApiService;
...
public class MainActivity extends AppCompatActivity implements TicketsAdapter.TicketsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TicketsAdapter(MainActivity.this, ticketsList, (TicketsAdapter.TicketsAdapterListener) this);
     ...
     //   recyclerView.addItemDecoration(new GridSpacingItemDecoration(1, dpToPx(5), true));
        ...
        disposable.add(
                ticketsObservable
                        ...
                        // we can change the here from concateMap to flatMap
    ...
    public void onTicketSelected(Ticket contact) {
        Toast.makeText(context, ""+contact.getFlightNumber(), Toast.LENGTH_SHORT).show();
    }
